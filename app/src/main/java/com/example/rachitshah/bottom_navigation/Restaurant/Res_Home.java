...
public class Res_Home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (id == R.id.res_home) {
            Intent intent = new Intent(Res_Home.this, Res_Home.class);
            startActivity(intent);
        } else if (id == R.id.res_recent) {
            Intent intent = new Intent(Res_Home.this, Res_Recent.class);
                      startActivity(intent);
        } else if (id == R.id.res_profile) {
            Intent intent = new Intent(Res_Home.this, Res_Profile.class);
            startActivity(intent);

        } else if (id == R.id.res_feedback) {
            Intent intent = new Intent(Res_Home.this, Feedback.class);
            startActivity(intent);
